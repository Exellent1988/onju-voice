...
void multicastPacket(String hostname)
{
...
void loop()
{
    ...
    if (Serial.available())
    {
        ...
        case 'M':
            ...
            break;
         case 'u':
            multicastPacket(WiFi.getHostname());
            Serial.println("[UART] Send Multicast");
            break;
        case 'm':
            mic_timeout = 0;
